<template>
   <div id="container">
      <h1 class="bold">Datenschutzerklärung</h1>
      <h2 class="bold">1. Datenschutz auf einen Blick</h2>
      <h3 class="bold">Allgemeine Hinweise</h3>
      <p>
      ...
      <h3 class="bold">Datenerfassung auf dieser Website</h3>
      <p class="bold">
      ...
      <p class="bold">Wie erfassen wir Ihre Daten?</p>
      <p>
      ...
      <p class="bold">Wofür nutzen wir Ihre Daten?</p>
      <p>
         Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der
         Website zu gewährleisten. Andere Daten können zur Analyse Ihres
         Nutzerverhaltens verwendet werden.
      </p>
      <p class="bold">Welche Rechte haben Sie bezüglich Ihrer Daten?</p>
      <p>
      ...
      <h2 class="bold">2. Hosting</h2>
      <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
      <h3 class="bold">Externes Hosting</h3>
      <p>
      ...
      <p>Netlify, Inc., 2325 3rd St #215, San Francisco, USA („Netlify“)</p>
      <h2 class="bold">3. Allgemeine Hinweise und Pflichtinformationen</h2>
      <h3 class="bold">Datenschutz</h3>
      <p>
      ...
      <h3 class="bold">Hinweis zur verantwortlichen Stelle</h3>
      <p>
      ...
      <h3 class="bold">Speicherdauer</h3>
      <p>
      ...
      <h3 class="bold">Empfänger von personenbezogenen Daten</h3>
      <p>
      ...
      <h3 class="bold">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
      <p>
      ...
      <h3 class="bold">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
      <p>
      ...
      <h3 class="bold">Recht auf Datenübertragbarkeit</h3>
      <p>
      ...
      <h3 class="bold">Auskunft, Berichtigung und Löschung</h3>
      <p>
      ...
      <h3 class="bold">Recht auf Einschränkung der Verarbeitung</h3>
      <p>
